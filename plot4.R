...
legend("topright", col=c("black", "orangered", "blue"), legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), bty = "n", lty=1)

# top right
with(data, plot(Time, Voltage, ylab = "Voltage", xlab="datetime", type = "l"))

# bottom right
with(data, plot(Time, Global_reactive_power, ylab = "Global_reactive_power", xlab="datetime", type = "l"))
